...
export function SupportTicketDetail({
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="space-y-1.5 min-w-0">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-xs text-slate-500 flex items-center space-x-1">
              ...
              <span>Khởi tạo lúc: {new Date(ticket.createdAt).toLocaleString('vi-VN')}</span>
            </span>
          </div>
        </div>
      ...
      {/* Nội dung yêu cầu (Phẳng, không nằm trong khung box) */}
      ...
      <div className="space-y-4 pt-2">
              ...
              {ticket.comments.map((comment) => {
                ...
                return (
                  <div key={comment.id} className="relative flex items-start space-x-3 sm:space-x-4">
                    ...
                    {/* Comment Content Card (Full Width) */}
                    <div
        ...
        {/* New Reply Form (Messenger Style) */}
              ...
              <textarea
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' && !e.shiftKey) {
                    e.preventDefault();
                    if (!isSubmittingComment && (commentText.trim() || commentAttachments.length > 0)) {
                      onAddComment(e);
                    }
                  }
                }}
