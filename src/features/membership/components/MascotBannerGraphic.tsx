...
export function MascotBannerGraphic({ onSlideChange }: MascotBannerGraphicProps) {
  ...
  return (
    <div className="relative w-full rounded-2xl overflow-hidden bg-slate-900 border border-slate-800 text-white flex flex-col justify-between">
      ...
      <div className="relative z-10 p-5 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 min-h-[190px]">
        {/* Left/Main Mascot Illustration Container */}
        <div className="w-full sm:w-2/5 aspect-[16/10] max-h-[140px] bg-slate-800/80 border border-slate-700/60 rounded-xl p-2 flex items-center justify-center relative overflow-hidden shrink-0">
          <div className="absolute top-2 left-2 z-20">
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-cyan-500/20 text-cyan-300 text-[10px] font-semibold border border-cyan-500/30">
        ...
        {/* Right Content Text */}
        <div className="w-full sm:w-3/5 space-y-2 text-left">
      ...
      <div className="relative z-10 px-4 py-2.5 bg-slate-950/80 border-t border-slate-800/80 flex items-center justify-between">
        {/* Navigation Arrows */}
