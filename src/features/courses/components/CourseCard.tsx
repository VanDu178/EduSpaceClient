...
export function CourseCard({ course, className = "" }: CourseCardProps) {
  return (
    <div
      className={`bg-white rounded-3xl overflow-hidden flex flex-col justify-between group border border-slate-200 hover:border-blue-500/40 transition-all duration-300 ${className}`}
    >
      <div>
        {/* Banner */}
